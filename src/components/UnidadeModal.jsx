        ...
        <AnimatePresence>
            <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
                ...
                >
                    ...
                    <div className="overflow-y-auto p-6 md:p-8 custom-scrollbar bg-white dark:bg-[#1c1f26] transition-colors">
                        <div className="grid grid-cols-1 md:grid-cols-12 gap-6">
                            ...
                            <div className="col-span-1 md:col-span-8">
                                ...
                                <input
                                    className={`w-full rounded-lg border bg-white dark:bg-[#111318] text-slate-900 dark:text-white h-11 px-4 placeholder:text-slate-400 dark:placeholder:text-slate-600 transition-colors shadow-sm dark:shadow-none ${errors.nome ? 'border-red-500 focus:border-red-500 focus:ring-red-500' : 'border-slate-200 dark:border-slate-800 focus:border-blue-500 focus:ring-blue-500'}`}
                    ...
                    {/* Footer */}
                    <div className="px-6 py-3 bg-slate-50 dark:bg-[#1c1f26] border-t border-slate-200 dark:border-slate-800 flex justify-end gap-3 rounded-b-xl transition-colors">
                        <button
                            onClick={onClose}
